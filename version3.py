...
cols = ['Date', 'Name', 'Party', 'Function', 'Statement', 'Debate Subject', 'Type of debate', 'Particular committee', 'URL']
    ...
    for debate in debates:
        ...
        for s in found_statements:
            ...
            if party == '-':
                ...
                for m in Minis['Name']:
                    if name_split[-1] in m:
                        function = Minis.Function[Minis.Name == m]
                        function = function.to_string(index=False)
                    else:
                        #function = 'Unknown'
                        m = ''
            else:
            ...
            if 'debatten' in s_url:
                ...
                data = data.append({'Date': date, 'Name': name, 'Party': party, 'Function': function, 'Statement': statement, 'Debate Subject': debate_sub, 'Type of debate': typ_deb, 'Particular committee': typ_com, 'URL': s_url},ignore_index=True)
